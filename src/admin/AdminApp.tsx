...
// //               target="_blank"
// //               rel="noreferrer"
// //               className="flex h-12 w-16 flex-none items-center justify-center overflow-hidden rounded-xl bg-white"
// //             >
// //               <img
...
// //                 target="_blank"
// //                 rel="noreferrer"
// //                 className="font-display text-xl font-semibold text-white transition hover:text-brand"
// //               >
// //                 Rathore vlogs
// //               </a>
...
// //               target="_blank"
// //               rel="noreferrer"
// //               className="flex h-11 w-14 flex-none items-center justify-center overflow-hidden rounded-xl bg-white"
// //             >
// //               <img
// //                 src="/rathore-vlogs-logo.jpg"
// //                 alt="Rathore Vlogs"
...
//                 @keyframes adminKirtiGlow {
//                   0%, 100% {
//                     opacity: 0.78;
//                     text-shadow:
//                       0 0 4px rgba(255, 85, 150, 0.35);
//                   }
//                   50% {
//                     opacity: 1;
//                     text-shadow:
//                       0 0 8px rgba(255, 85, 150, 0.95),
//                       0 0 18px rgba(255, 85, 150, 0.65),
//                       0 0 28px rgba(255, 190, 90, 0.30);
//                   }
//                 }

//                 @keyframes adminWelcomeStar {
//                   0% {
...
//             <div className="leading-tight">
//               <p
//                 className="flex items-center font-display text-base font-semibold"
//                 style={{
//                   animation:
//                     "adminWelcomeFloat 2s ease-in-out infinite",
//                 }}
//               >
...
//                 <span
//                   className="ml-1 inline-block italic text-brand-2"
//                   style={{
//                     animation:
//                       "adminKirtiGlow 1.4s ease-in-out infinite",
//                   }}
//                 >
//                   Kirti
//                 </span>
...
//                   style={{
//                     animation:
//                       "adminWelcomeStar 1.8s linear infinite",
//                     transformOrigin:
//                       "center",
//                   }}
//                 >
...
//     <>
//       <div
//         className="rounded-2xl border border-white/10 bg-gradient-to-r from-plum-2/60 via-plum to-brand/30 p-6"
//         style={{
//           animation:
//             "overviewCardIn 0.8s ease-out both",
//         }}
//       >
//         <style>
//           {`
...
//             @keyframes overviewWelcomeGlow {
//               0%, 100% {
//                 opacity: 0.75;
//                 text-shadow:
//                   0 0 4px rgba(255, 195, 95, 0.25);
//               }
//               50% {
//                 opacity: 1;
//                 text-shadow:
//                   0 0 8px rgba(255, 195, 95, 0.9),
//                   0 0 18px rgba(255, 195, 95, 0.45);
//               }
//             }

//             @keyframes overviewNameFloat {
//               0%, 100% {
//                 transform: translateY(0);
//               }
//               50% {
...
//             @keyframes overviewNameGlow {
//               0%, 100% {
//                 text-shadow:
//                   0 0 5px rgba(255, 85, 150, 0.25);
//               }
//               50% {
//                 text-shadow:
//                   0 0 8px rgba(255, 85, 150, 0.95),
//                   0 0 18px rgba(255, 85, 150, 0.6);
//               }
//             }
...
//           style={{
//             animation:
//               "overviewWelcomeGlow 2s ease-in-out 2",
//           }}
//         >
//           Welcome back
//         </p>
...
//         <h2
//           className="mt-1 flex items-center font-display text-2xl font-semibold"
//           style={{
//             animation:
//               "overviewNameFloat 2s ease-in-out 2",
//           }}
//         >
//           <span
...
//             style={{
//               animation:
//                 "overviewNameGlow 1.6s ease-in-out 2",
//             }}
//           >
//             {session?.username ??
//               "Admin"}
...
//             style={{
//               animation:
//                 "overviewWave 1.8s ease-in-out 2",
//               transformOrigin:
//                 "70% 70%",
//             }}
//           >
